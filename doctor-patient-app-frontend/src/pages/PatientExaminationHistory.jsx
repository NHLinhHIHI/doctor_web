...
import { FaArrowLeft,FaSpinner, FaEnvelope, FaSearch, FaCalendarAlt, FaPrint, FaInfoCircle, FaTimes, FaArrowUp, FaPills } from 'react-icons/fa';
  ...
  <html>
    <head>
      ...
      <style>
        ...
        .footer { margin-top: 40px; font-style: italic; text-align: right;font-size: 18px;   font-weight: 500;   padding-right: 10px;   }
      </style>
    </head>
    ...
    <body>
      ...
      <div class="footer">
        ...
        Ngày khám: ${formatDateTime(exam.examinationDate)}<br/>
